...
class MainActivity : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun setupLaunchers() {
        ...
        val adapter = LaunchersAdapter(this, displayedLaunchers, this, launchers_grid, launchers_fastscroller) {
            ...
            } else if (it.packageName == "com.android.jv.ink.launcherink") {
                var intent = Intent();
                intent.setClassName("com.android.jv.ink.launcherink", "com.android.jv.ink.launcherink.ui.home.JvMainActivity" );
                startActivity(intent);
            } else if (it.packageName == "com.baoliyota.epdparams") {
            } else if (it.packageName == "com.zeusis.factorytest") {
                var intent = Intent();
                intent.setClassName("com.zeusis.factorytest", "com.zeusis.factorytest.base.MirrorActivity" );
                startActivity(intent);
            } else {
